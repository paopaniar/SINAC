...
class FactoryConexion
{
    public static string CreateConnection()
    {
        ...
        {
            if (ConfigurationManager.ConnectionStrings[i].Name.Equals("SINAC.Properties.Settings.Conexion", StringComparison.InvariantCultureIgnoreCase))
                existe = true;
        }
        ...
        return ConfigurationManager.ConnectionStrings["SINAC.Properties.Settings.Conexion"].ConnectionString;
    }
    public static string CreateConnection(string pUsuario, String pContrasena)
    {
        ...
        conexion.AppendFormat("{0}", ConfigurationManager.ConnectionStrings["SINAC.Properties.Settings.Conexion"].ConnectionString);
        // Agrega al usuario
